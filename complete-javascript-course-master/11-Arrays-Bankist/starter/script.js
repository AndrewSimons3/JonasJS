...
// const randomDiceRoll = Array.from({length: 100}, (_, i) => Math.floor(Math.random() * 6 + 1));
...
// portion and add it to the object as a new property. Do NOT create a new array, simply loop 
// over the array. Forumla: recommendedFood = weight ** 0.75 * 28. (The result is in grams of 
