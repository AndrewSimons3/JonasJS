...
//       return fetch(`https://restcountries.com/v2/${data.country}`);
//     })
//     .then(res => {
...
to the provided image path. When the image is done loading, append it to the DOM element with 
the 'images' class, and resolve the promise. The fulfilled value should be the image element itself. In case there is an error loading the image ('error' event), reject the promise.
...
a second image (HINT: Use the image element returned by the createImage promise to hide the 
